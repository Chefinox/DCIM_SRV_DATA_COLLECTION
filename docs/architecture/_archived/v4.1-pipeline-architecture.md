...
> **Menggantikan**: `docs/architecture/v4.0-pipeline-architecture.md` (2026-06-12, tetap dipertahankan sebagai arsip referensi)
...
>
> Dokumen v4.0 **tidak diubah**; semua penambahan ada di dokumen v4.1 ini agar jejak versi tetap terpisah dan dapat diaudit.
...
16. [AI Readiness: Status MT-015](#16-ai-readiness-status-mt-015)
17. [Jadwal Eksekusi (Cron & Systemd)](#17-jadwal-eksekusi-cron--systemd)
...
flowchart LR
    ...
    subgraph L13["🧠 AI Training Data Archive — PROPOSAL"]
        direction TB
    ...
    style L13 fill:#ede7f6,stroke:#5e35b1,stroke-dasharray: 6 4
    ...
    class ARCH_JOB,ARCH_TBL,ARCH_VIEW,AI_CONSUMER proposalFlow
```
...
## 17. Jadwal Eksekusi (Cron & Systemd)
