...
|---|---|---|
| iTop | `:8080` | `admin / literal:<SET_LOCALLY>` (REST API basic auth) |
...
| NiFi | `:8443` (HTTPS) | `admin / literal:<SET_LOCALLY>` |
...
```bash
# iTop REST
curl -u "admin:literal:<SET_LOCALLY>" "http://10.70.0.56:8080/webservices/rest.php?version=1.3&json_data=..."
...
# NiFi GUI
https://10.70.0.56:8443/nifi  (admin / literal:<SET_LOCALLY>)
```
