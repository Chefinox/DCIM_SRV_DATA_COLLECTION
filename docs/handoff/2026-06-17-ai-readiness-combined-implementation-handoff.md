...
- **Kredensial live:**
  - PostgreSQL: `PGPASSWORD="literal:<SET_LOCALLY>" psql -h localhost -U sot_admin -d dcim_sot`
  - Elasticsearch: `elastic` / `ES_OLD_PASSWORD_REDACTED` @ `https://localhost:9200` (pakai `-k`)
