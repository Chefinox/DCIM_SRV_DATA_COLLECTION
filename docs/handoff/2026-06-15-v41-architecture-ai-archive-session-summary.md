...
PGPASSWORD="literal:<SET_LOCALLY>" psql -h localhost -U sot_admin -d dcim_sot
...
curl -s -k -u "elastic:ES_OLD_PASSWORD_REDACTED" "https://localhost:9200/dcim-metrics-unified-*/_count" -d '{"query":{"match_all":{}}}' -H 'Content-Type: application/json'
