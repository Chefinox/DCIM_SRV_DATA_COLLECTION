...
| SNMP v3 — APC UPS (`192.168.100.140`) | `hndept` | Auth: `literal:<SET_LOCALLY>` / Priv: `literal:<SET_LOCALLY>` |
| SNMP v3 — Synology NAS (`10.50.0.105–110`) | `hndept` | Auth/Priv: `F!tech0918` |
| PostgreSQL SOT | `sot_admin` | `literal:<SET_LOCALLY>` @ `192.168.101.73:5432` / DB: `dcim_sot` |
