...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED https://10.70.0.56:9200/_cat/indices?v`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED https://10.70.0.56:9200/_cat/indices?v | grep 2026.04.16`*
...
*User accepted the command `sleep 15 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED https://10.70.0.56:9200/_cat/indices?v | grep mikrotik`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf--2026.04.16/_search?q=measurement:server_redfish&size=1"`*
...
*User accepted the command `sleep 30 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED https://10.70.0.56:9200/_cat/indices?v | grep server`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=1&pretty"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=10&pretty" | grep "source" | sort | uniq`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=100&pretty" | grep "source" | sort | uniq`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search" -H 'Content-Type: application/json' -d '{"size":0,"aggs":{"measurements":{"terms":{"field":"measurement_name"}}}}'`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search" -H 'Content-Type: application/json' -d '{"size":0,"aggs":{"measurements":{"terms":{"field":"measurement_name"}}}}' | jq .aggregations.measurements.buckets`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_mapping?pretty"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_mapping?pretty" | grep "measurement_name"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search" -H 'Content-Type: application/json' -d '{"size":0,"aggs":{"measurements":{"terms":{"field":"measurement_name.keyword"}}}}' | jq .aggregations.measurements.buckets`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search" -H 'Content-Type: application/json' -d '{"size":1,"pretty"}'`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=1&pretty"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-ups-2026.04.16/_search?size=1&pretty"`*
...
*User accepted the command `sudo systemctl reload telegraf && sleep 5 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-2026.04.16/_search?size=1&pretty"`*

*Checked command status*

*User accepted the command `sleep 10 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-2026.04.16/_search?size=1&pretty&sort=@timestamp:desc"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-mikrotik-2026.04.16/_search?size=1&pretty"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-mikrotik-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must_not":{"term":{"measurement_name.keyword":"interface"}}}},"size":1}'`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=5&pretty" | grep -i "version"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search" -H 'Content-Type: application/json' -d '{"query":{"exists":{"field":"server_redfish.total_cores"}},"size":1,"pretty"}'`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED -X GET "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=1&pretty" -H 'Content-Type: application/json' -d '{"query":{"exists":{"field":"server_redfish.total_cores"}}}'`*

*Checked command status*

*User accepted the command `curl -k -i -u hndept:"F!tech@0918" -X GET "https://10.50.0.5/redfish/v1/Systems/1" --max-time 10`*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=50&pretty" | grep -A 5 -B 5 "server_redfish" | grep -v "reading" | head -n 100`*
...
*User accepted the command `sudo systemctl reload telegraf && sleep 10 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server_inventory-2026.04.16/_search?size=1&pretty"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/_cat/indices/*2026.04.16?v"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf--2026.04.16/_search?size=1&pretty"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-metrics-2026.04.16/_search?size=1&pretty"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/*2026.04.16/_search?size=1&pretty" -H 'Content-Type: application/json' -d '{"query":{"term":{"measurement_name.keyword":"server_inventory"}}}'`*
...
*User accepted the command `sleep 20 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server_inventory-2026.04.16/_search?size=1&pretty"`*

*Checked command status*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/*inventory*/_search?size=1&pretty"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/_cat/indices?v&s=index"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-metrics-2026.04.16/_search?size=1&pretty" -H 'Content-Type: application/json' -d '{"query":{"term":{"measurement_name.keyword":"server_inventory"}}}'`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"term":{"measurement_name.keyword":"server_inventory"}},"size":1}'`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_redfish"}},{"wildcard":{"tag.name.keyword":"*CPU*"}}]}},"size":20}' | grep "tag.name" | sort | uniq`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_redfish"}},{"wildcard":{"tag.name.keyword":"*CPU*"}}]}},"size":50}' | grep "tag.name" | sort | uniq`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_redfish"}},{"wildcard":{"tag.name.keyword":"*CPU*"}}]}},"size":5}' | grep -A 2 -B 2 "tag.name"`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=20&pretty" | grep "tag.name" | head -n 20`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?size=50&pretty" | grep "tag.name" | sort | uniq > /home/infra/dcim_metrics_project/scratch/temp_tags.txt && cat /home/infra/dcim_metrics_project/scratch/temp_tags.txt`*

*Checked command status*

*Viewed [temp_tags.txt](file:///home/infra/dcim_metrics_project/scratch/temp_tags.txt) *

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"size":0,"query":{"term":{"measurement_name.keyword":"server_redfish"}},"aggs":{"all_tags":{"terms":{"field":"tag.name.keyword","size":100}}}}'`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"size":0,"query":{"term":{"measurement_name.keyword":"server_redfish"}},"aggs":{"all_tags":{"terms":{"field":"tag.name.keyword","size":100}}}}' | grep "key" | sort | uniq`*

*Checked command status*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"size":0,"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_redfish"}},{"wildcard":{"tag.name.keyword":"*CPU*"}}]}},"aggs":{"cpu_tags":{"terms":{"field":"tag.name.keyword"}}}}' | grep "key"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/*2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"query_string":{"query":"*Utilization*"}},"size":5}'`*
...
*User accepted the command `sudo systemctl restart telegraf && sleep 10 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.5"}}]}},"size":5}'`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty" -H 'Content-Type: application/json' -d '{"query":{"exists":{"field":"server_inventory.FirmwareVersion"}},"size":1}'`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty&size=3" -H 'Content-Type: application/json' -d '{"query":{"term":{"measurement_name.keyword":"server_inventory"}},"_source":["server_inventory","tag"]}'`*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-2026.04.16/_search?pretty&size=1" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"exists":{"field":"server_inventory.FirmwareVersion"}}]}},"_source":["server_inventory","tag"]}'`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search?pretty&size=1" -H 'Content-Type: application/json' -d '{"_source":true}' 2>/dev/null | head -n 60`*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search?pretty&size=2" -H 'Content-Type: application/json' -d '{"query":{"exists":{"field":"device_info"}},"_source":true}' 2>/dev/null | head -n 80`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search?pretty&size=1&sort=@timestamp:desc" -H 'Content-Type: application/json' -d '{"query":{"term":{"device_type.keyword":"NVR"}}}' 2>/dev/null | head -n 60`*

*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search?pretty&size=1&sort=@timestamp:desc" -H 'Content-Type: application/json' -d '{"query":{"term":{"device_type.keyword":"NVR"}}}' 2>/dev/null | grep -A 60 '"storage"'`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search?pretty&size=5" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.5"}}]}},"_source":["server_inventory.BiosVersion", "server_inventory.HostName", "server_inventory.FirmwareVersion", "tag.url", "@timestamp"], "sort":[{"@timestamp":"desc"}]}'`*
...
*User accepted the command `sudo systemctl restart telegraf && sleep 15 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search?pretty&size=1" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.5"}}]}},"sort":[{"@timestamp":"desc"}]}'`*
...
*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.5"}}]}},"sort":[{"@timestamp":"desc"}],"size":1}' | jq .hits.hits[0]._source`*
...
*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.5"}},{"exists":{"field":"server_inventory.FirmwareVersion"}}]}},"sort":[{"@timestamp":"desc"}],"size":1}' | jq .hits.hits[0]._source`*
...
sleep 15
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.5"}},{"exists":{"field":"server_inventory.FirmwareVersion"}}]}},"sort":[{"@timestamp":"desc"}],"size":1}' | jq .hits.hits[0]._source
`*
...
*User accepted the command `sleep 5 && curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.5"}}]}},"sort":[{"@timestamp":"desc"}],"size":1}' | jq .hits.hits[0]._source`*
...
*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}}]}},"sort":[{"@timestamp":"desc"}],"size":1}' | jq .hits.hits[0]._source`*
...
*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"query":{"bool":{"must":[{"term":{"measurement_name.keyword":"server_inventory"}},{"term":{"tag.address.keyword":"10.50.0.2"}}]}},"sort":[{"@timestamp":"desc"}],"size":1}' | jq .hits.hits[0]._source`*
...
*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"match_all":{}}}' | jq .hits.hits[0]._source | head -50`*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/_cat/indices?v&s=index" | grep -E "telegraf|cctv"`*

*Checked command status*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}]}' | jq '{measurement: .hits.hits[0]._source.measurement_name, tag: .hits.hits[0]._source.tag}'`*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"exists":{"field":"system_routerboard"}}}' | jq .hits.hits[0]._source | head -40`*

*Checked command status*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}]}' | jq '.hits.hits[0]._source | {measurement_name, tag}'`*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"device_type.keyword":"NVR"}}}' | jq '{device_type: .hits.hits[0]._source.device_type, ip: .hits.hits[0]._source.ip, serial: .hits.hits[0]._source.device_info.serialNumber, model: .hits.hits[0]._source.device_info.model}'`*

*Checked command status*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"device_type.keyword":"CCTV"}}}' | jq '{device_type: .hits.hits[0]._source.device_type, ip: .hits.hits[0]._source.ip, serial: .hits.hits[0]._source.device_info.serialNumber, model: .hits.hits[0]._source.device_info.model}'`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":50,"_source":["measurement_name","tag"],"query":{"match_all":{}},"aggs":{"measurements":{"terms":{"field":"measurement_name.keyword","size":20}}}}' | jq .aggregations`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"measurement_name.keyword":"mikrotik"}}}' | jq .hits.hits[0]._source`*
...
[[outputs.elasticsearch]]
  ...
  insecure_skip_verify = true
  username = "elastic"
  password = "ES_OLD_PASSWORD_REDACTED"
  namepass = ["dcim_inventory"]
EOF
`*

*User accepted the command `sudo systemctl restart telegraf && sleep 10 && curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/_cat/indices/dcim-inventory-*?v"`*
...
*User accepted the command `curl -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/_cat/indices/*?v&s=index" | grep dcim-inventory`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/dcim-inventory-2026.04.17/_search?pretty&size=1" | jq .hits.hits[0]._source`*
...
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"tag.device_type.keyword":"ups"}}}' > scratch/raw_ups.json

# Query Lenovo Server (Inventory)
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"measurement_name.keyword":"server_inventory"}}}' > scratch/raw_server.json

# Query Mikrotik
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"measurement_name.keyword":"mikrotik"}}}' > scratch/raw_mikrotik.json

# Query Hikvision (NVR)
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"device_type.keyword":"NVR"}}}' > scratch/raw_nvr.json

# Query Hikvision (CCTV)
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"device_type.keyword":"CCTV"}}}' > scratch/raw_cctv.json
`*
...
echo "### [APC UPS]"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"tag.device_type.keyword":"ups"}}}' | jq -r '.hits.hits[0]._source | "1. Model: \(.ups_apc.model)\n2. Serial Number: \(.ups_apc.serial_number)\n3. Hostname: \(.ups_apc.system_name)\n4. Firmware: \(.ups_apc.firmware_version)\n5. IP: \(.tag.agent_host)\n6. Device Type: \(.tag.device_type)\n7. Timestamp: \(.["@timestamp"])"'
echo ""

# Server Results
echo "### [Lenovo Server]"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"measurement_name.keyword":"server_inventory"}}}' | jq -r '.hits.hits[0]._source | "1. Model: \(.server_inventory.Model)\n2. Serial Number: \(.server_inventory.SerialNumber)\n3. Hostname: \(.server_inventory.HostName)\n4. Firmware: \(.server_inventory.FirmwareVersion)\n5. IP: \(.tag.address)\n6. Device Type: \(.tag.device_type)\n7. Timestamp: \(.["@timestamp"])"'
echo ""

# MikroTik Results
echo "### [MikroTik]"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"measurement_name.keyword":"mikrotik"}}}' | jq -r '.hits.hits[0]._source | "1. Model: \(.mikrotik.system_description)\n2. Serial Number: \(.mikrotik.serial_number)\n3. Hostname: \(.tag.system_name)\n4. Firmware: \(.mikrotik.firmware_version)\n5. IP: \(.tag.agent_host)\n6. Device Type: \(.tag.device_type)\n7. Timestamp: \(.["@timestamp"])"'
echo ""

# Hikvision NVR Results
echo "### [Hikvision NVR]"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"device_type.keyword":"NVR"}}}' | jq -r '.hits.hits[0]._source | "1. Model: \(.device_info.model)\n2. Serial Number: \(.device_info.serialNumber)\n3. Hostname: \(.device_info.deviceName)\n4. Firmware: \(.device_info.firmwareVersion)\n5. IP: \(.ip)\n6. Device Type: \(.device_type)\n7. Timestamp: \(.["@timestamp"])"'
echo ""

# Hikvision CCTV Results
echo "### [Hikvision CCTV]"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"device_type.keyword":"CCTV"}}}' | jq -r '.hits.hits[0]._source | "1. Model: \(.device_info.model)\n2. Serial Number: \(.device_info.serialNumber)\n3. Hostname: \(.device_info.deviceName)\n4. Firmware: \(.device_info.firmwareVersion)\n5. IP: \(.ip)\n6. Device Type: \(.device_type)\n7. Timestamp: \(.["@timestamp"])"'
`*
...
echo "UPS:"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-*/_search?size=1" | jq -c '.hits.hits[0]._source'
echo "Server:"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search?size=1" | jq -c '.hits.hits[0]._source'
echo "MikroTik:"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search?size=1" | jq -c '.hits.hits[0]._source'
echo "NVR:"
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search?size=1" | jq -c '.hits.hits[0]._source'
`*

*Checked command status*

*User accepted the command `# UPS
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-*/_search?size=1" | jq -r '.hits.hits[0]._source | "### [APC UPS]\n1. Model: \(.ups_apc.model)\n2. Serial Number: \(.ups_apc.serial_number)\n3. Hostname: \(.ups_apc.system_name)\n4. Firmware: \(.ups_apc.firmware_version)\n5. IP: \(.tag.agent_host)\n6. Device Type: \(.tag.device_type)\n7. Timestamp: \(.["@timestamp"])\n"'
`*

*Checked command status*

*User accepted the command `# Server
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search?size=1" | jq -r '.hits.hits[0]._source | "### [Lenovo Server]\n1. Model: \(.server_inventory.Model)\n2. Serial Number: \(.server_inventory.SerialNumber)\n3. Hostname: \(.server_inventory.HostName)\n4. Firmware: \(.server_inventory.FirmwareVersion)\n5. IP: \(.tag.address)\n6. Device Type: \(.tag.device_type)\n7. Timestamp: \(.["@timestamp"])\n"'
`*

*Checked command status*

*User accepted the command `# MikroTik
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search?size=1" | jq -r '.hits.hits[0]._source | "### [MikroTik]\n1. Model: \(.mikrotik.system_description)\n2. Serial Number: \(.mikrotik.serial_number)\n3. Hostname: \(.tag.system_name)\n4. Firmware: \(.mikrotik.firmware_version)\n5. IP: \(.tag.agent_host)\n6. Device Type: \(.tag.device_type)\n7. Timestamp: \(.["@timestamp"])\n"'

# NVR
curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"term":{"device_type.keyword":"NVR"}}}' | jq -r '.hits.hits[0]._source | "### [Hikvision NVR]\n1. Model: \(.device_info.model)\n2. Serial Number: \(.device_info.serialNumber)\n3. Hostname: \(.device_info.deviceName)\n4. Firmware: \(.device_info.firmwareVersion)\n5. IP: \(.ip)\n6. Device Type: \(.device_type)\n7. Timestamp: \(.["@timestamp"])\n"'
`*
...
*User accepted the command `sudo systemctl restart telegraf && sleep 10 && curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/dcim-inventory-*/_search?size=1" | jq .hits.hits[0]._source | grep u_`*

*Checked command status*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search?size=1" | jq .hits.hits[0]._source | grep u_`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search?size=1" | jq .hits.hits[0]._source`*
...
*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"exists":{"field":"tag.u_serial"}}}' | jq .hits.hits[0]._source.tag`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/dcim-inventory-*/_search?size=1" | jq .hits.hits[0]._source.tag`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/dcim-inventory-*/_search?size=1" | jq .hits.hits[0]._source`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-ups-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"exists":{"field":"tag.u_serial"}}}' | jq .hits.hits[0]._source.tag`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/cctv-metrics-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"exists":{"field":"u_serial"}}}' | jq .hits.hits[0]._source | grep u_`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"exists":{"field":"u_serial"}}}' | jq .hits.hits[0]._source | grep u_ip`*
...
*User accepted the command `sudo systemctl restart telegraf && sleep 10 && curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search?size=1" | jq .hits.hits[0]._source | grep u_ip`*

*Checked command status*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-server-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"exists":{"field":"tag.u_serial"}}}' | jq .hits.hits[0]._source`*
...
*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/dcim-inventory-*/_search" -H 'Content-Type: application/json' -d '{"size":3,"sort":[{"@timestamp":"desc"}],"query":{"match_all":{}}}' | jq -c '.hits.hits[] | {time: ._source["@timestamp"], type: ._source.tag.u_device_type, serial: ._source.tag.u_serial}'`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"match_all":{}}}' | jq -c '.hits.hits[0] | {time: ._source["@timestamp"], tags: .._source.tag}'`*

*Checked command status*

*User accepted the command `curl -s -k -u elastic:ES_OLD_PASSWORD_REDACTED "https://10.70.0.56:9200/telegraf-mikrotik-*/_search" -H 'Content-Type: application/json' -d '{"size":1,"sort":[{"@timestamp":"desc"}],"query":{"match_all":{}}}' | jq -c '.hits.hits[0]._source | {time: .["@timestamp"], u_serial: .tag.u_serial}'`*
