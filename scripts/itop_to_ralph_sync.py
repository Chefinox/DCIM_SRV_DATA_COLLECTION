...
ITOP_PASS = read_secret("ITOP_API_PASS", os.getenv("ITOP_API_PASS", "literal:<SET_LOCALLY>"))
...
DB_CONFIG = {
    ...
    "password": read_secret("SOT_DB_PASS", os.getenv("SOT_DB_PASS", "literal:<SET_LOCALLY>")),
}
