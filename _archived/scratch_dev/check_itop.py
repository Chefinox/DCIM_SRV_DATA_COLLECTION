...
data = {"auth_user": "admin", "auth_pwd": "literal:<SET_LOCALLY>", "json_data": json.dumps({"operation": "core/get", "class": "Peripheral", "key": "SELECT Peripheral", "output_fields": "name,serialnumber"})}
